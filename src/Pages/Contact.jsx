...
const Contact = () => {
  return (
    ...
    <section className="text-gray-600 body-font bg-white shadow-lg rounded-lg p-8 w-full max-w-5xl">
        <div className="container flex flex-col md:flex-row w-full px-5 py-12 md:py-24 mx-auto section" id="contact-form">
            <div className="md:w-1/3 w-full">
                ...
                <p className="leading-relaxed text-xl text-gray-900">
                    ...
                    <a href="mailto:contact@example.com" className="font-semibold border-b-4 border-green-400">contact@example.com</a>
                </p>
